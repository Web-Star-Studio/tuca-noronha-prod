            ...
            <Card className="bg-white dark:bg-slate-800/50 border-slate-200 dark:border-slate-700/50 shadow-sm">
              ...
              <CardContent className="space-y-6 pt-2">
                ...
                {reservation.guestNames && reservation.guestNames.length > 0 && (
                  <div className="rounded-md bg-slate-100 dark:bg-slate-700/50 p-4">
                    <p className="text-sm font-medium text-slate-600 dark:text-slate-300 mb-2">Participantes adicionais</p>
